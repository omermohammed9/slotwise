...
- Current Phase 12 public-page progress note: hosted booking-page configuration is now available by business slug, but the actual public frontend page remains deferred.
...
- Phase 16 status: frontend/backend feature alignment is now the active frontend implementation phase; the first coverage matrix and route-map/app-shell routing slice are complete, and the next gated implementation slice is shared API DTO/client modules.
